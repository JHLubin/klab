...
init('-enzdes::cstfile htra1_cat_general.cst -cst_fa_weight 2.0 -run:preserve_header')
...
pose = pose_from_pdb('ext_cat_pre_relax.pdb')
cstm.apply(pose)

jd = PyJobDistributor('ext_cat_relax_3/ext_cat_relax4', 5, get_fa_scorefxn())
